    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('freelancer', 'Freelancer'), ('client', 'Client')], default='freelancer', max_length=12)),
                ('avatar', models.ImageField(blank=True, upload_to='avatars/')),
                ('headline', models.CharField(blank=True, max_length=120)),
                ('bio', models.TextField(blank=True)),
                ('location', models.CharField(blank=True, max_length=80)),
                ('skills', models.CharField(blank=True, help_text='Comma-separated skills', max_length=250)),
